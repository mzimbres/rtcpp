...
use $n = 1$, they may be simply implemented in terms of
...
no way of knowing with rebound type is used for array and node allocation. Once
...
there are two ways to do this (if we want indeed to use a
