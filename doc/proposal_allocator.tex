...
demand this feature from their allocators, with a cost in performance
and unnecessary complexity. (The unordered associative containers uses
sized allocations in addition to node allocation, which means they
need the sized version of \texttt{allocate}).
...
allocations with different sizes, which is exactly what I am trying to
avoid for reasons mentioned above i.e. reduce complexity, improve
performance etc.
